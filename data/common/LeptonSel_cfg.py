...
MuonWP = {
            ...
            "cut_Tight_HWWW": {
                "cuts": {
                    ...
                    "True": [
                        'abs(muon_col[LF_idx]["eta"]) < 2.4',
                        'muon_col[LF_idx]["tightId"] == 1',
                        'abs(muon_col[LF_idx]["dz"]) < 0.15',
                        'muon_col[LF_idx]["pfIsoId"] >= 4',
                    ],
                    # dxy for pT < 20 GeV
                    'muon_col[LF_idx]["pt"] <= 20.0': [
                        'abs(muon_col[LF_idx]["dxy"]) < 0.01 ',
    ...
    "Full2023PreBPix_v12": {
        ...
        "TightObjWP": {
            ...
            "cut_highPtId_tightPFISO": {
                "cuts": {
                    # Common cuts
                    "True": [
                        'abs(muon_col[LF_idx]["eta"]) < 2.4',
                        'muon_col[LF_idx]["highPtId"] == 1',
                        'abs(muon_col[LF_idx]["dz"]) < 0.5',
                        'muon_col[LF_idx]["pfIsoId"] == 4',
                    ],
                    # dxy for pT < 20 GeV
